...
if (isset($_POST['submit_action']) && $_POST['submit_action'] === 'Upload') {
    ...
    processSubmitForm($competition_type, $kontakt_id, $name, $surname, $vyhra, $address, $uploaded_files, $shortToken);
    // }
}

function processSubmitForm($competition_type, $kontakt_id, $name, $surname, $vyhra, $address, $uploaded_files, $shortToken)
{
    global $wpdb;
    if ($uploaded_files) {
        ...
        //        $page_url = get_option('siteurl') . "/index.php" . "/my-page-" . $name . $surname . $kontakt_id . $shortToken;
